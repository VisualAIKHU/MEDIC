    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            if random.random() < 0.5:
                d_feat_path = os.path.join(self.d_feat_dir, str(img_idx)+'.png.npy')
                d_img_path = os.path.join(self.d_img_dir, str(img_idx)+'.png')
            else:
                d_feat_path = os.path.join(self.d_feat_dir, str(img_idx)+'.png.npy')
                d_img_path = os.path.join(self.d_img_dir, str(img_idx)+'.png')
        else:
        ...
        q_feat_path = os.path.join(self.s_feat_dir, str(img_idx)+'_2.png.npy')
        q_img_path = os.path.join(self.s_img_dir, str(img_idx)+'_2.png')
