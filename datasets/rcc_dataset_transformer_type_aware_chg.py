...
class RCCDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (d_feature, n_feature, q_feature, seq, labels_with_ignore, \
                neg_seq, neg_labels_with_ignore, mask, neg_mask, \
                aux_label_pos, aux_label_neg, d_img_path, n_img_path, q_img_path)
...
def rcc_collate(batch):
    ...
    return (d_feat_batch, n_feat_batch, q_feat_batch, seq_batch, label_with_ignore_batch, \
            neg_seq_batch, neg_label_with_ignore_batch, mask_batch, neg_mask_batch, \
            aux_label_pos_batch, aux_label_neg_batch, d_img_batch, n_img_batch, q_img_batch)
